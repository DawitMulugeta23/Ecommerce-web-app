...
const AdminAddProduct = () => {
  ...
  return (
    <div className={`min-h-screen py-12 px-4 ${isDarkMode ? "dark" : ""}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full border-2 border-gray-100 dark:border-gray-700 p-3 rounded-xl focus:border-blue-500 outline-none transition bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              value={formData.name}
              onChange={(e) =>
          ...
          <div>
            ...
            <select
              className="w-full border-2 border-gray-100 dark:border-gray-700 p-3 rounded-xl focus:border-blue-500 outline-none transition bg-white dark:bg-gray-800 text-gray-900 dark:text-white cursor-pointer"
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white py-4 rounded-2xl font-black text-lg hover:bg-blue-700 transition-all shadow-lg shadow-blue-100 dark:shadow-none active:scale-95"
          >
            ምርት መዝግብ
          </button>
        </form>
